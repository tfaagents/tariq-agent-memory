---
name: contacts
description: Who Tariq deals with and what they handle. Base layer from 120 days of mail metadata to 10 Sep 2026; names, roles and numbers confirmed from his own sent mail are dated. Kept current by the nightly learn run.
---

## Inside TFA
- Kendal (kendal@): 406 out, 90 in. Everything admin, DA payments, quotes, property
  checks, tenders inbox, student placements. His most-emailed person by four times.
- Heather / accounts@ (heather@, accounts@): payments (ABA file "for payment today"),
  MYOB, insurance policies, land tax, tax debt notices, QBCC annual reporting prep,
  weekly invoice approvals. Signs off "😊 H". Queries anything she cannot trace in the
  bank feed, by name and amount.
- Clay (clay@, personal claywhart@gmail.com): projects, concept fee proposals, decision
...
- MSP Law: **Geoff Chen** (listed in Outlook as Zhi Chen, geoff@msplaw.com.au, 0468 987
  ...
  **Mohammed Patel** (Mohammed@msplaw.com.au): title searches, Hi-Tech Court, and from
  10 Sep 2026 chasing Ray White South West over the Dan Street handover.
- Piper Alderman: Theo Calligeros (Dan St acquisition, Eight Mile Plains renewal, urgent
...
- **Modus Property Group: Freddie** (freddie@moduspg.au), the line back to the previous
  owners of Dan Street.
- **Indara** (digital infrastructure, tower on the Eight Mile Plains site): **Christine
...
- Xero invoices (SEQ Landscape Supplies, Saunders Waste), Approved Joinery, Sniip
  ...
  Upwork (Heather's weekly billing report), Lloyds Auctions (daily, noise).
- QBCC licence correspondence goes to **tfa.constructions@hotmail.com**, not the main
  mailbox. Worth remembering when something official seems to be missing.
